...
@FXML TextField batValueSit1Series, resistanceSit1Series, currentSit1Series1, batValueSit2Series,
        ...
        voltage1Sit3Series, voltage2Sit3Series, voltage3Sit3Series,currentSit3Series, batValueSit1Parallel, resistance1Sit1Parallel,
...
//HANDLE OUTPUTS
    ...
    public void setVolt1ValueSit3Series() {
        try{
            ...
            labelVolt1Sit3Series.setText(res1Series3.getVoltage()+" V");
            if (voltage1 < 0) {
                throw new IllegalArgumentException(); 
            }   
        } catch (NumberFormatException ex){
    ...
    public void setVolt2ValueSit3Series() {
        try{
            double voltage1 = Double.parseDouble(voltage2Sit3Series.getText());
            res2Series3.setVoltage(voltage1);
            labelVolt2Sit3Series.setText(res2Series3.getVoltage()+" V");
            if (voltage1 < 0) {
                throw new IllegalArgumentException(); 
            }   
        } catch (NumberFormatException ex){
    ...
    public void setVolt3ValueSit3Series() {
        try{
            double voltage1 = Double.parseDouble(voltage3Sit3Series.getText());
            res3Series3.setVoltage(voltage1);
            labelVolt3Sit3Series.setText(res3Series3.getVoltage()+" V");
            if (voltage1 < 0) {
                throw new IllegalArgumentException(); 
            }   
        } catch (NumberFormatException ex){
    ...
    public void handleCalculateSit1Parallel(){
       ...
       //RESULT IF HAVE RESISTANCE AND CURRENT
           ...
           if (voltage1 != voltage2){
               alert.setAlertType(Alert.AlertType.ERROR);
                alert.setHeaderText("ERROR");
                alert.setContentText("Don't forget that the Voltage in a Parallel Circuit is always equal. Please verify your input !");
                alert.showAndWait();
           }
           else {
           double voltageTotal = voltage1;
